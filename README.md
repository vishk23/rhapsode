...
- **Voice Profile → AI that writes like you.** Your dictation history *is* your voice, captured at scale — so [Tools/voice-profile](Tools/voice-profile) distills it into a **voice pack**: your full corpus, your vocabulary with real counts, and verbatim passages of how you actually reason. Hand it to any AI agent and it writes copy that sounds like you, not like a model. Privacy filters keep anything you'd rather exclude out of every regeneration, and a ready-made [`/write-as-me` skill](Tools/voice-profile/skill-template/SKILL.md) wires it into Claude Code.
